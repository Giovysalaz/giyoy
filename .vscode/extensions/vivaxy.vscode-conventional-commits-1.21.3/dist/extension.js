...
var _chalk = _interopRequireDefault(__webpack_require__(6195));
...
const colorConvert = __webpack_require__(3347);
...
const ansiStyles = __webpack_require__(6643);
const stdoutColor = __webpack_require__(2978).stdout;

const template = __webpack_require__(7238);
...
/* MIT license */
var cssKeywords = __webpack_require__(8248);
...
var conversions = __webpack_require__(6070);
var route = __webpack_require__(4351);
...
const hasFlag = __webpack_require__(4514);
...
const header_min_length_1 = __webpack_require__(5392);
...
const {stdout: stdoutColor, stderr: stderrColor} = __webpack_require__(2130);
const {
	stringReplaceAll,
...
const gitmojis = __webpack_require__(1225);
const prompt_types_1 = __webpack_require__(934);
const keys = __webpack_require__(6318);
const commit_message_1 = __webpack_require__(7562);
const commitlint_1 = __webpack_require__(7170);
const localize_1 = __webpack_require__(5023);
function prompts({ gitmoji, showEditor, emojiFormat, lineBreak, promptScopes, promptBody, promptFooter, }) {
    return __awaiter(this, void 0, void 0, function* () {
...
function createQuickPick({ placeholder, items = [], format = (i) => i, step, totalSteps, noneItem, }) {
    return __awaiter(this, void 0, void 0, function* () {
        const pickerItems = items;
        if (noneItem) {
            pickerItems.unshift(noneItem);
        }
        const selectedItems = yield quick_pick_1.default({
            placeholder,
...
function createInputBox({ placeholder, format = (i) => i, step, totalSteps, validate = () => undefined, }) {
...
function createConfigurableQuickPick({ placeholder, format = (i) => i, step, totalSteps, configurationKey, newItem, noneItem, newItemWithoutSetting, validate = () => undefined, }) {
    return __awaiter(this, void 0, void 0, function* () {
        ...
        let selectedValue = yield createQuickPick({
            placeholder,
            items,
            step,
            totalSteps,
        ...
        if (selectedValue === newItem.label) {
            selectedValue = yield createInputBox({
 ...
 */
const vscode = __webpack_require__(7549);
function createQuickPick({ placeholder, items = [], format = (i) => i, step, totalSteps, }) {
    return new Promise(function (resolve) {
        ...
        picker.onDidAccept(function () {
            if (picker.selectedItems.length) {
                const result = format(picker.selectedItems);
                picker.dispose();
                resolve(result);
            }
        });
